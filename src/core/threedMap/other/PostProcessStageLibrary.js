...
PostProcessStageLibrary.createDepthOfFieldStage = function() {
    ...
    var dof = new Cesium.PostProcessStage({
        name: 'czm_depth_of_field_composite',
        fragmentShader: Cesium.DepthOfField,
        uniforms: {
            focalDistance: 5.0,
...
PostProcessStageLibrary.createEdgeDetectionStage = function() {
    ...
    var name = Cesium.createGuid();
    return new Cesium.PostProcessStage({
        name: 'czm_edge_detection_' + name,
        fragmentShader: Cesium.EdgeDetection,
        uniforms: {
            length: 0.25,
...
function getSilhouetteEdgeDetection(edgeDetectionStages) {
    ...
    var edgeDetection = new Cesium.PostProcessStageComposite({
    ...
    var edgeComposite = new Cesium.PostProcessStage({
...
PostProcessStageLibrary.createSilhouetteStage = function(edgeDetectionStages) {
    ...
    var silhouetteProcess = new Cesium.PostProcessStage({
        ...
        fragmentShader: Cesium.Silhouette,
        uniforms: {
...
PostProcessStageLibrary.createBloomStage = function() {
    var contrastBias = new Cesium.PostProcessStage({
        ...
        fragmentShader: Cesium.ContrastBias,
        uniforms: {
            contrast: 128.0,
            brightness: -0.3
        }
    ...
    var bloomComposite = new Cesium.PostProcessStage({
        ...
        fragmentShader: Cesium.BloomComposite,
        uniforms: {
            glowOnly: false,
...
PostProcessStageLibrary.createAmbientOcclusionStage = function() {
    var generate = new Cesium.PostProcessStage({
        name: 'czm_ambient_occlusion_generate',
        fragmentShader: Cesium.AmbientOcclusionGenerate,
        uniforms: {
            intensity: 3.0,
            bias: 0.1,
            lengthCap: 0.26,
    ...
    var generateAndBlur = new Cesium.PostProcessStageComposite({
        name: 'czm_ambient_occlusion_generate_blur',
        stages: [generate, blur]
    });

    var ambientOcclusionModulate = new Cesium.PostProcessStage({
        name: 'czm_ambient_occlusion_composite',
        fragmentShader: Cesium.AmbientOcclusionModulate,
        uniforms: {
...
PostProcessStageLibrary.createModifiedReinhardTonemappingStage = function(useAutoExposure) {
    var fs = useAutoExposure ? '#define AUTO_EXPOSURE\n' : '';
    fs += Cesium.ModifiedReinhardTonemapping;
    return new Cesium.PostProcessStage({
...
PostProcessStageLibrary.createAutoExposureStage = function() {
    return new Cesium.AutoExposure();
};
...
PostProcessStageLibrary.createBlackAndWhiteStage = function() {
    return new Cesium.PostProcessStage({
        ...
        fragmentShader: Cesium.BlackAndWhite,
        uniforms: {
            gradations: 5.0
        }
    });
...
PostProcessStageLibrary.createBrightnessStage = function() {
    return new Cesium.PostProcessStage({
        name: 'czm_brightness',
        fragmentShader: Cesium.Brightness,
        uniforms: {
            brightness: 0.5
        }
    });
...
PostProcessStageLibrary.createNightVisionStage = function() {
    return new Cesium.PostProcessStage({
        ...
        fragmentShader: Cesium.NightVision
    });
};
...
PostProcessStageLibrary.createDepthViewStage = function() {
    return new Cesium.PostProcessStage({
        name: 'czm_depth_view',
        fragmentShader: Cesium.DepthView
    });
};
...
PostProcessStageLibrary.createLensFlareStage = function() {
    return new Cesium.PostProcessStage({
        name: 'czm_lens_flare',
        fragmentShader: Cesium.LensFlare,
        uniforms: {
            dirtTexture: Cesium.buildModuleUrl('Assets/Textures/LensFlare/DirtMask.jpg'),
            starTexture: Cesium.buildModuleUrl('Assets/Textures/LensFlare/StarBurst.jpg'),
            intensity: 2.0,
            distortion: 10.0,
            ghostDispersal: 0.4,
            haloWidth: 0.4,
            dirtAmount: 0.4,
            earthRadius: Cesium.Ellipsoid.WGS84.maximumRadius
        }
    });
};
